...
FalknerGroup:
	...
	db  8, HOOTHOOT, NO_ITEM,    HYPNOSIS, MUD_SLAP, GROWL, PECK
	db  10,  PIDGEOTTO,  BERRY,  TACKLE, MUD_SLAP, QUICK_ATTACK, PECK
	db -1 ; end

	; FALKNER (2): Rematch
	db "FALKNER@", TRAINERTYPE_ITEM_MOVES
	db  54, NOCTOWL,  GOLD_BERRY,   PSYCHIC_M, SKY_ATTACK, HYPNOSIS, DREAM_EATER
...
BugsyGroup:
	...
	db 15, ARIADOS,  NO_ITEM,      SCARY_FACE, LEECH_LIFE, NIGHT_SHADE, POISON_STING
	db 16, SCYTHER, BERRY_JUICE,   QUICK_ATTACK, FURY_CUTTER, CUT, PURSUIT
	db -1 ; end

	; BUGSY (2): Rematch
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 54, HERACROSS,      FOCUS_BAND,   MEGAHORN, CROSS_CHOP, REST, SLEEP_TALK
...
ClairGroup:
	...
	db 42, SEADRA,     GOLD_BERRY,      RAIN_DANCE, HYDRO_PUMP, DRAGONBREATH, NO_MOVE
	...
	db 54, GYARADOS,   LEFTOVERS,      CRUNCH, HYDRO_PUMP, DOUBLE_EDGE, THUNDER
	db -1 ; end
